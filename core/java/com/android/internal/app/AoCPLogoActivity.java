...
public class AoCPLogoActivity extends Activity {
    Toast mToast;
    ImageView mContent;
    int mCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContent.setImageResource(com.android.internal.R.drawable.aocplogo_alt);
        ...
        mContent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mToast.show();
                mContent.setImageResource(com.android.internal.R.drawable.aocplogo);
            }
        });
            ...
            public boolean onLongClick(View v) {
                try {
                    startActivity(new Intent(Intent.ACTION_MAIN)
                        ...
                        .addCategory("com.android.internal.category.AoCPLOGO"));
                        //.setClassName("com.android.systemui","com.android.systemui.UnicornSack"));
                } catch (ActivityNotFoundException ex) {
                    android.util.Log.e("AoCPLogoActivity", "Couldn't find a sack of unicorns.");
                }
                finish();
                return true;
            }
