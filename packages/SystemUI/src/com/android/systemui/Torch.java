...
/*
 * Torch is a LED and Screen flashlight.
 */
public class Torch extends Activity implements SurfaceHolder.Callback {
    ...
    private void setScreen() {
			...
			getWindow().setBackgroundDrawableResource(R.drawable.flashback);
    ...
    private StatusBarManager getStatusBarManager() {
        return (StatusBarManager) getSystemService(Context.STATUS_BAR_SERVICE);
    }
	
	private void disablePhoneSleep() {
        WindowManager.LayoutParams scron = getWindow().getAttributes();
		scron.flags |= WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON;
		getWindow().setAttributes(scron);
    }
	
    private void setBrightness(float brightness) {
           WindowManager.LayoutParams sb = getWindow().getAttributes();
           sb.screenBrightness = brightness;
           getWindow().setAttributes(sb);
    }
